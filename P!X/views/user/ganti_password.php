...
<style>
    ...
    .form-input:focus {
        ...
        box-shadow: 0 0 0 3px rgba(58, 141, 182, 0.1);
    }
    ...
    .btn-primary:hover {
        ...
        box-shadow: 0 4px 12px rgba(58, 141, 182, 0.3);
    }
...
<div class="password-container">
    ...
    <div class="password-form">
        <form method="POST" action="index.php?module=auth&action=gantiPasswordUser">
            ...
            <div class="form-actions">
                ...
                <a href="index.php?module=user&action=dashboard" class="btn-secondary">
                    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
